...
<head>
    ...
    <title>S.E.E Difference Africa</title>
    ...
    <div id="home">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            ...
            <div class="navbar-collapse collapse" id="menu">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="about-us.php"><button type="button" class="btn btn-outline-success">About Us</button></a>
                    </li>
                     <li class="nav-item">
                        <a class="nav-link" href="soon.php"><button type="button" class="btn btn-outline-success">Upcoming Events</button></a>
                    <li class="nav-item">
                        <a class="nav-link" href="news.php"><button type="button" class="btn btn-outline-success">News</button></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="background" id="background">
            <div class="p-b-60" id="cards">
                <h2 style="margin-left: 240px" id="about-header">About Us</h2>
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="details">
                                ...
                                <div class="description">
                                    <div class="container">
                                        <p>To combat Social, Economic and Environmental matters and in so doing help all people lead healthy, productive lives. In developing countries, it focuses on improving people's health and giving them the chance to lift themselves out of hunger and extreme poverty.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
