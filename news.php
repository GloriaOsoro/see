...
<html>
  <head>
    <title>News | S.E.E Difference Africa</title>
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
            <div class="navbar-brand">
                  <a style="text-decoration:none;color:#0000FF;" href="index.php"><img src="images/logo3.png" alt="logo" width="50" height="50" style="border-radius: 60px; margin-left: 35px; margin-bottom: 4px;"> S.E.E Difference Africa</a>
            </div>
            <!--  -->
      ...
      <div class="wrapper style1" style="padding-top: 10%;">
        ...
        <!-- footer -->
        <!-- Footer -->
         <div class="wrapper style1" style="padding-top: 34%;">
